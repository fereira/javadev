...
public class HttpUtils {
    ...
    public HttpResponse<String> httpCustomGetRequest(String uri, Optional<Map<String, String>> headers) throws URISyntaxException, IOException, InterruptedException {
       ...
       HttpClient client = HttpClient.newHttpClient();
       Builder builder = getRequestBuilder(new URI(uri), headers, 1); 
    ...
    public HttpResponse<String> httpCustomPostRequest(String uri, String body, Optional<Map<String, String>> headers) throws URISyntaxException, IOException, InterruptedException {
        HttpClient client = HttpClient.newHttpClient();
        Builder builder = postRequestBuilder(new URI(uri), headers, 1, body); 
        HttpRequest request = builder.build(); 
        HttpResponse<String> response = client.send(request, BodyHandlers.ofString());
    ...
    public HttpResponse<String> httpCustomPutRequest(String uri, String body, Optional<Map<String, String>> headers) throws URISyntaxException, IOException, InterruptedException {
        HttpClient client = HttpClient.newHttpClient();
        Builder builder = postRequestBuilder(new URI(uri), headers, 1, body); 
        HttpRequest request = builder.build(); 
        HttpResponse<String> response = client.send(request, BodyHandlers.ofString());
    ...
    protected Builder getRequestBuilder(URI uri,  Optional<Map<String, String>> additionalHeaders, int timeOut) {
    ...
    protected Builder postRequestBuilder(URI uri, Optional<Map<String, String>> additionalHeaders, int timeOut, String body) {
    ...
    protected Builder postFormRequestBuilder(URI uri, Optional<Map<String, String>> additionalHeaders, int timeOut, Map<Object, Object> data) {
        // Random 256 length string is used as multipart boundary
        String boundary = new BigInteger(256, new Random()).toString();
    ...
    protected Builder putRequestBuilder(URI uri, Optional<Map<String, String>> additionalHeaders, int timeOut, String body) {
        // Random 256 length string is used as multipart boundary
        //String boundary = new BigInteger(256, new Random()).toString();
